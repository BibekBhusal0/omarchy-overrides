...
-- FIX: third party plugin not allowed to access apps (temporarily disable them)
-- bind(modKey("SUPER_L"), "omarchy-shell shell toggle super-apps", "Apps")
-- bind(modKey("ALT + SPACE"), "omarchy-shell shell toggle super-apps", "Apps")
bind(modKey("SUPER_L"), "omarchy-shell shell toggle omarchy.menu '{\"menu\":\"apps\"}'", "Apps")
bind(modKey("ALT + SPACE"), "omarchy-shell shell toggle omarchy.menu '{\"menu\":\"apps\"}'", "Apps")
